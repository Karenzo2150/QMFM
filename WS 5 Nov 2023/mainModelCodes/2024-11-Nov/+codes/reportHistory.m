...
if optsRH.shocks.run
  ...
  rprt = codes.reporting.addShocks(opts, rprt, m, db, optsFH.rangePlot, legends, "history");
  ...
  rprt = codes.reporting.addTablePage(opts, rprt, m, db, optsFH.rangeTable, varNames, tableTitle, legends);
