...
opts.roundId        = "2024 Nov Forecast";
opts.modelFile      = "minecofin";
opts.mainDataFile   = "2024-09-30"; % name of data/Rwametric file 
opts.addDataFile    = "2024-09-01"; % has CBO proj RIR-US and old GTM numbers
opts.compRound      = "main/2024-09-Sept"; % comparison round
...
opts.parameterLegends = ["Nov'24 recalib", "Sept'24 Original"];

%% Actions to run

% If 'true' or =1 , the whole program runs

opts.readModel.run                    = 0;
...
opts.histForecast.range = qq(2022,4) : qq(2023,1);
...
opts.forecastReport.tableRange = qq(2023,1) : qq(2028,4); % extend 2028Q4
