...
tunes.shock_dl_cpi_core = Series(qq(2025,4):qq(2026,4), [1, 0.5, 0.5, 0.5, 0.5]); 

% 3b. CPI_food soft-tune 2024Q4 a.f. if further shock expected  
%rngExog = qq(2025, 4): qq(2025,4);
tunes.shock_dl_cpi_food = Series(qq(2024,4):qq(2025,3), [2, 1, 0.5, 0.5]);
...
pln = endogenize(pln, rngExog, 'shock_l_s');
%tunes.l_s(rngExog) = 100*(log(1311.1) + log(1 + 0.09/4)); % ann.depr in 2024Q3 assumed 9% from end-June
