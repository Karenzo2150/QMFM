function rprt = addDecompositions(opts, rprt, m, db, range, legends)
...
for i = 1:paramNum
  ...
  decompContribs = [ ...
    + db.a1_cons(i) * db.l_gcons_gap{:,i}{-1}, ...
    + db.shock_l_gcons_gap{:,i} ...
    ];
...
legendEntries = ["Consumption gap", "Investment gap", "Gov. cons. gap", "Export gap", "Shock"];
...
for i = 1:paramNum
  ...
  decompContribs = [ ...
    ...
    + db.w_imp_gcons(i)  * db.l_gcons_gap{:,i}, ...
...
seriesName    = "l_y_gap";
legendEntries = ["Consumption gap", "Investment gap", "Gov. cons. gap", "Export gap", ...
  "Import gap", "Shock"];
...
for i = 1:paramNum
  ...
  decompContribs = [ ...
    ...
    + db.w_y_gcons(i)  * db.l_gcons_gap{:,i}, ...
...
for i = 1:paramNum
  ...
  decompContribs = [ ...
    ...
    + db.d6(i) * (db.dl_gcons_tnd{:,i} - db.dl_y_tnd{:,i}), ...
    + db.shock_def_str{:,i};
    ];
