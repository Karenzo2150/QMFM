...
opts.mainDataFile   = "2026-06-06"; % name of data/Rwametric file 
...
% Filtered range
opts.filterHistory.range = qq(2006, 1) : qq(2025, 4); % default 2024Q2 if data; extend filter for shocktuning +2Q
...
opts.forecastReport.tableRange = qq(2025, 3) : opts.forecast.range(end); % extend 2028Q4
