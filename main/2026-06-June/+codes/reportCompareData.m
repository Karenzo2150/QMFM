...
% codes.reportCompareData() compares the current and previous observed data.
%
% Usage: codes.reportCompareData()
%
% codes.reportCompareData loads the current and comparison observed data,
% and creates a PDF report showing the series side-by-side in charts. The
% report contains comparison charts for the both series in dbObs, as well as
% in dbAux.
%
...
%                     QMFM folder)
%
% The PDF report is saved as opts.resultsDirPdf/dataCompareReport.pdf
%
...
codes.utils.saveResult(optsCurr, "dataComp", "dbCompObs", "dbCompAux");
