...
legend ('Core', 'Food' ,'Energy', 'Discrep. shock', 'Target',...
...
legend(fisc_decomp.legendEntries, ...
  ...
  'orientation', 'horizontal');
highlight(HighRange);
title('Fiscal impulse,(% GDP) components ', 'FontSize', 12,...
  'interpreter', 'none');
...
grid on
%highlight(HighRange); %,'EdgeColor','m','LineWidth',1.5);
legend ('Foreign demand growth, Y-on-Y % change', 'Trend', 'interpreter', 'none','Fontsize',10,...
     'location', 'southoutside', 'orientation', 'horizontal');
title('Trading partner demand vs trend, Y-on-Y growth in %','interpreter', 'none','FontSize',12);
...
grid on
%highlight(HighRange); %,'EdgeColor','m','LineWidth',1.5);
legend ('Foreign food price, Y-on-Y % change', 'Trend', 'interpreter', 'none','Fontsize',10, ...
    'location', 'southoutside', 'orientation', 'horizontal');
...
grid on
%highlight(HighRange); %,'EdgeColor','m','LineWidth',1.5);
legend ('Foreign energy price, Y-on-Y % change', 'Trend', 'interpreter', 'none','Fontsize',10, ...
    'location', 'southoutside', 'orientation', 'horizontal');
...
legend ('Foreign RIR %', 'Trend', 'interpreter', 'none', 'Fontsize', 10, ...
    'location', 'southoutside', 'orientation', 'horizontal');
title('Foreign real interest rate vs trend (US), in %','interpreter', 'none','FontSize',12);
...
grid on
highlight(HighRange); %,'EdgeColor','m','LineWidth',1.5);
legend ('trading partner CPI, Y-on-Y % change', 'ss trend',  'interpreter', 'none','Fontsize',10,...
    'location', 'southoutside', 'orientation', 'horizontal');
...
% Real GDP
figure("visible", "on");
plot(plotRange, db.d4l_cpi, 'linewidth', 2); %'color', 'b');
hold on
plot(plotRange, db.d4l_cpi_tar, 'linewidth', 2);%'color', 'red');
zeroline;
grid on
hold on
highlight(HighRange); %,'EdgeColor','m','LineWidth',1.5);
legend ('Level', 'Target', 'interpreter', 'none','Fontsize', 10,...
    'location', 'southoutside', 'orientation', 'horizontal');
title('Inflation, YY %','interpreter', 'none','FontSize',12);
