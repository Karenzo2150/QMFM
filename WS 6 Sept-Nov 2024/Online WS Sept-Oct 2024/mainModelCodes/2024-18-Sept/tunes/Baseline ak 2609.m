...
% 3a. CPI_core soft-tune 2024Q4 a.f. if further shock expected 
...
rngExog = qq(2024,3) : qq(2024,4);
tunes.shock_l_inv_gap(rngExog) = [ 0.14,  -0.9]; % need to be read from ext.filter results
tunes.shock_l_exp_gap(rngExog) = [ 0.31,  -2.0]; % 
tunes.shock_l_imp_gap(rngExog) = [-0.07,  0.01]; %
